...
/// - AppKit release notes for macOS 14 (announces the deprecation):
///   <https://developer.apple.com/documentation/macos-release-notes/appkit-release-notes-for-macos-14>
/// - `NSRunningApplication.activate(options:)` (the modern path):
///   <https://developer.apple.com/documentation/appkit/nsrunningapplication/activate(options:)>
/// - `NSApplicationActivateAllWindows`:
///   <https://developer.apple.com/documentation/appkit/nsapplication/activationoptions/activateallwindows>
